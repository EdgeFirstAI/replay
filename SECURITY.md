...
We take the security of EdgeFirst Replay seriously. If you discover a security
...
1. **Email**: Send details to support@au-zone.com with subject line:
   "Security Vulnerability - EdgeFirst Replay"
2. **GitHub Security Advisory**: Use the
   [private reporting feature](https://github.com/EdgeFirstAI/replay/security/advisories/new)
...
EdgeFirst Replay has specific security considerations:

- **DMA Buffer Access**: Requires elevated privileges for DMA buffer operations
- **System Service Control**: Can stop system services when using `--system` flag
- **MCAP Parsing**: MCAP files are untrusted input and are parsed defensively
